...
// (DO NOT EDIT: machine generated header) 'FMX.Media.pas' rev: 33.00 (Windows)
...
/*Helper*/typedef void *TDevicePositionHelper;

/*Helper*/typedef void *TFlashModeHelper;

/*Helper*/typedef void *TFocusModeHelper;

/*Helper*/typedef void *TTorchModeHelper;

/*Helper*/typedef void *TVideoCaptureQualityHelper;

struct TVideoCaptureSetting;
class DELPHICLASS TVideoCaptureDevice;
class DELPHICLASS TCaptureDeviceManager;
/*Helper*/typedef void *TCameraKindHelper;
...
#ifndef _WIN64
typedef System::TMetaClass* TCaptureDeviceClass;
#else /* _WIN64 */
...
#ifndef _WIN64
	System::DynamicArray<TVideoCaptureSetting> __fastcall GetDefaultCanvasCaptureSettings();
#else /* _WIN64 */
...
#ifndef _WIN64
	virtual System::DynamicArray<TVideoCaptureSetting> __fastcall DoGetAvailableCaptureSettings() = 0 ;
#else /* _WIN64 */
...
#ifndef _WIN64
	System::DynamicArray<TVideoCaptureSetting> __fastcall GetAvailableCaptureSettings(const Fmx::Graphics::TCanvasClass ACanvasClass);
...
#ifndef _WIN64
typedef System::TMetaClass* TCustomMediaCodecClass;
#else /* _WIN64 */
...
private:
	static const System::Int8 PrecentCount = System::Int8(0x64);
...
//-- var, const, procedure ---------------------------------------------------
static const int MediaTimeScale = int(0x989680);
}	/* namespace Media */
}	/* namespace Fmx */
